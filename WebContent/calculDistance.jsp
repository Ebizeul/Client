		...
		if(oui1 && oui2){
			if(varVille1 != null && varVille2 != null){
				...
				resultat = 6371*Math.acos(
	 					Math.sin((latitude1*Math.PI)/180) * Math.sin((latitude2 * Math.PI)/180) + Math.cos((latitude1*Math.PI)/180)*Math.cos((latitude2*Math.PI)/180)*Math.cos((longitude1*Math.PI)/180 - longitude2*Math.PI/180));
